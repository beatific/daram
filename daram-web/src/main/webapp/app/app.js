...
define([
		...
		'config/route-config', //registers에 각 프로바이더를 제공하기 위해 임포트
	],
...
*/	
	...
	function (angular, routeConfig) {
		...
		//모듈 선언
	    var app = angular.module("daramApp", ['ngRoute'], function ($provide, $compileProvider, $controllerProvider, $filterProvider) {
