...
public class Response {
   ...
   * Individual check results
   */
  protected final transient List<GraphResult> graphResults = new ArrayList<GraphResult>();
  ...
  public void addGraphResult(final GraphResult graphResult) {
  ...
  public List<GraphResult>getGraphReslts() {
